	...
	public class GameStage
	{
		...
		{			
			switch(c)
			{
				...
				{
					main.addCollection(Character(new Dog1(this.main, px, py, l, d, 2, this.main.base.DOG1)));
					break;
				}
				case this.main.base.DOG2:
				{
					main.addCollection(Character(new Dog2(this.main, px, py, l, d, 2, this.main.base.DOG2)));
					break;
				}
				case this.main.base.DOG3:
				{
					main.addCollection(Character(new Dog3(this.main, px, py, l, d, 2, this.main.base.DOG3)));
					break;
				}
				case this.main.base.DOG4:
				{
					main.addCollection(Character(new Dog4(this.main, px, py, l, d, 2, this.main.base.DOG4)));
					break;
				}
			}
		}		
